...
int main(int argc, char *argv[]){
  ...
  1f:	e8 ee 02 00 00       	call   312 <chdir>
  ...
  29:	78 18                	js     43 <main+0x43>
	{
 	...
 	exit();
  2b:	e8 72 02 00 00       	call   2a2 <exit>
#include "fcntl.h"
...
int main(int argc, char *argv[]){
  ...
  30:	52                   	push   %edx
  31:	52                   	push   %edx
  32:	68 10 07 00 00       	push   $0x710
  37:	6a 01                	push   $0x1
  39:	e8 b2 03 00 00       	call   3f0 <printf>
		exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 38f:	f7 f6                	div    %esi
 391:	0f b6 92 48 07 00 00 	movzbl 0x748(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 508:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 50b:	b8 3f 07 00 00       	mov    $0x73f,%eax
...
free(void *ap)
{
 ...
 591:	a1 e0 09 00 00       	mov    0x9e0,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5e7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5e9:	a3 e0 09 00 00       	mov    %eax,0x9e0
}
 5ee:	5b                   	pop    %ebx
 5ef:	5e                   	pop    %esi
 5f0:	5f                   	pop    %edi
 ...
 60a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 60d:	a3 e0 09 00 00       	mov    %eax,0x9e0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 629:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 62c:	8b 15 e0 09 00 00    	mov    0x9e0,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6cf:	89 15 e0 09 00 00    	mov    %edx,0x9e0
      return (void*)(p + 1);
 ...
 6e4:	eb e9                	jmp    6cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6e6:	c7 05 e0 09 00 00 e4 	movl   $0x9e4,0x9e0
 6ed:	09 00 00 
 6f0:	c7 05 e4 09 00 00 e4 	movl   $0x9e4,0x9e4
 6f7:	09 00 00 
    base.s.size = 0;
 6fa:	b8 e4 09 00 00       	mov    $0x9e4,%eax
 6ff:	c7 05 e8 09 00 00 00 	movl   $0x0,0x9e8
 706:	00 00 00 
