...
int main(int argc, char *argv[])
{
  ...
  45:	52                   	push   %edx
  46:	6a 00                	push   $0x0
  48:	ff 77 08             	pushl  0x8(%edi)
  4b:	e8 02 03 00 00       	call   352 <open>
  50:	83 c4 10             	add    $0x10,%esp
  53:	85 c0                	test   %eax,%eax
  55:	89 c6                	mov    %eax,%esi
  57:	79 19                	jns    72 <main+0x72>
  59:	eb 5c                	jmp    b7 <main+0xb7>
  5b:	90                   	nop
  ...
  bb:	68 a7 07 00 00       	push   $0x7a7
  c0:	6a 01                	push   $0x1
  c2:	e8 99 03 00 00       	call   460 <printf>
	exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ff:	f7 f6                	div    %esi
 401:	0f b6 92 c4 07 00 00 	movzbl 0x7c4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 ba 07 00 00       	mov    $0x7ba,%eax
...
free(void *ap)
{
 ...
 657:	89 08                	mov    %ecx,(%eax)
  freep = p;
 659:	a3 80 0a 00 00       	mov    %eax,0xa80
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 67d:	a3 80 0a 00 00       	mov    %eax,0xa80
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 73f:	89 15 80 0a 00 00    	mov    %edx,0xa80
      return (void*)(p + 1);
 ...
 754:	eb e9                	jmp    73f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 80 0a 00 00 84 	movl   $0xa84,0xa80
 75d:	0a 00 00 
 760:	c7 05 84 0a 00 00 84 	movl   $0xa84,0xa84
 767:	0a 00 00 
    base.s.size = 0;
 76a:	b8 84 0a 00 00       	mov    $0xa84,%eax
 76f:	c7 05 88 0a 00 00 00 	movl   $0x0,0xa88
 776:	00 00 00 
